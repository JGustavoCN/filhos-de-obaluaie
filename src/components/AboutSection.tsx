      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <p className="text-lg md:text-xl text-on-surface/90 leading-relaxed whitespace-pre-line">
              {texto}
            </p>
          </div>
              ...
              <ul className="flex flex-col gap-3">
                {pilares.map((pilar: string, index: number) => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-primary">{icons[index % 4]}</span>
                      <span className="text-sm">{pilar}</span>
                    </li>
                  )
                })}
              </ul>
